...
import { ArrowUpCircle, Sparkles, X, RefreshCw, Download, CheckCircle, AlertTriangle, ShieldAlert } from 'lucide-react';
        ...
        <div className="p-6 space-y-5 text-slate-800 dark:text-neutral-200">
          ...
          {changelogItems.length > 0 && (
            <div>
              ...
              <div className="bg-slate-50 dark:bg-neutral-950/60 rounded-2xl p-4 border border-slate-100 dark:border-neutral-800/80 max-h-48 overflow-y-auto">
